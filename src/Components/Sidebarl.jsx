...
function Sidebarl() {
  ...
  return (
    <div>
      <div className="w-12 min-w-[40px] h-full flex flex-col items-center justify-between border-r-[1px] border-[#191d20] bg-[#343746]">
        <div className="flex flex-col items-center   justify-center">
          <Link to="/">
            <svg
              className={`h-14 w-14 py-3  hover:bg-[#3c3d51] md:cursor-pointer ${
                pathname === "/" ? "border-l-8 border-[#bd93f9]" : ""
              }`}
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
              fill={
                pathname === "/" ? "rgb(225, 228, 232)" : "rgb(106, 115, 125)"
              }
          ...
          <a href="https://github.com/ankitjangidx" target="_blank">
            <svg
              className={`h-14 w-14 py-3  hover:bg-[#3c3d51] md:cursor-pointer ${
                pathname === "/github" ? "border-l-8 border-[#bd93f9]" : ""
              }`}
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
              fill={
                pathname === 1 ? "rgb(225, 228, 232)" : "rgb(106, 115, 125)"
              }
          ...
          <Link to="project">
            <svg
              className={`h-14 w-14 py-3  hover:bg-[#3c3d51] md:cursor-pointer ${
                pathname === "/project" ? "border-l-8 border-[#bd93f9]" : ""
              }`}
              viewBox="0 0 16 16"
              xmlns="http://www.w3.org/2000/svg"
              fill={
          ...
          <Link to="contact">
            <svg
              className={`h-14 w-14 py-3  hover:bg-[#3c3d51] md:cursor-pointer ${
                pathname === "/contact" ? "border-l-8 border-[#bd93f9]" : ""
              }`}
              viewBox="0 0 16 16"
              xmlns="http://www.w3.org/2000/svg"
              fill={
        ...
        <div className="flex flex-col items-center   justify-center">
          <Link to="about">
            <svg
              className={`h-14 w-14 py-3  hover:bg-[#3c3d51] md:cursor-pointer ${
                pathname === "/about" ? "border-l-8 border-[#bd93f9]" : ""
              }`}
              viewBox="0 0 16 16"
              xmlns="http://www.w3.org/2000/svg"
              fill={
          ...
          <svg
            className={`h-14 w-14 py-3  hover:bg-[#3c3d51] md:cursor-pointer ${
              pathname === "/setting" ? "border-l-8 border-[#bd93f9]" : ""
            }`}
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
            fill={pathname === 5 ? "rgb(225, 228, 232)" : "rgb(106, 115, 125)"}

      ...
      <div className="w-12 min-w-[40px] h-full flex flex-col items-center justify-between border-r-[1px] border-[#191d20] bg-[#343746]">
        <div className="flex flex-col items-center   justify-center">
          <svg
            ...
            fill={
              activeImgIndex === 0 ? "rgb(225, 228, 232)" : "rgb(106, 115, 125)"
            }
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            fill={
              activeImgIndex === 1 ? "rgb(225, 228, 232)" : "rgb(106, 115, 125)"
            }
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            fill={
              activeImgIndex === 2 ? "rgb(225, 228, 232)" : "rgb(106, 115, 125)"
            }
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            fill={
              activeImgIndex === 3 ? "rgb(225, 228, 232)" : "rgb(106, 115, 125)"
            }
        ...
        <div className="flex flex-col items-center   justify-center">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            fill={
              activeImgIndex === 4 ? "rgb(225, 228, 232)" : "rgb(106, 115, 125)"
            }
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            fill={
              activeImgIndex === 5 ? "rgb(225, 228, 232)" : "rgb(106, 115, 125)"
            }
